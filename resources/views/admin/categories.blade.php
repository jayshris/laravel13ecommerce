            ...
            <form action="{{ route('admin.categories') }}" method="GET"
                ...
                <div class="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                    ...
                    <select name="status" onchange="this.form.submit()"
                        ...
                        <option value="0"
                            {{ request('status') == 0 && request()->filled('status') ? 'selected' : '' }}>Inactive
                        </option>
                    </select>
                                ...
                                <td class="px-6 py-4">
                                    <div
                                        ...
                                        <img src="{{ asset('uploads/categories') }}/{{ $cat->image }}"
                                            class="max-w-[30px] max-h-[30px] object-contain" alt="{{ $cat->name }}"
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form id="delete-form-{{ $cat->id }}" method="POST"
                                            action="{{ route('admin.category.delete', ['id' => $cat->id]) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                                ...
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">Are you sure you want to delete <strong
                                                id="delete-name" class="text-gray-800">this category</strong>? All
                                            of
...
<script>
    ...
    function deleteCat(buttonElement, brandName, brandId) {
        ...
        brandNameSpan.textContent = brandName || "this category";
